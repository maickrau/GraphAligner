...
LINKFLAGS = $(CPPFLAGS) -Wl,-Bstatic $(LIBS) -Wl,-Bdynamic -Wl,--as-needed -lpthread -pthread -static-libstdc++ `pkg-config --libs libdivsufsort` `pkg-config --libs libdivsufsort64` $(LTCMALLOCFLAGS)
