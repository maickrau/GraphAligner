...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {initialBandwidth, rampBandwidth, graph, std::numeric_limits<size_t>::max(), quietMode, false, lowMemory, 1, 0, nondeterministicOptimizations, preciseClippingIdentityCutoff, Xdropcutoff, 0};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {initialBandwidth, rampBandwidth, graph, maxCellsPerSlice, quietMode, sloppyOptimizations, lowMemory, minClusterSize, seedExtendDensity, nondeterministicOptimizations, preciseClippingIdentityCutoff, Xdropcutoff, multimapScoreFraction};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {initialBandwidth, rampBandwidth, graph, maxCellsPerSlice, quietMode, sloppyOptimizations, lowMemory, minClusterSize, seedExtendDensity, nondeterministicOptimizations, preciseClippingIdentityCutoff, Xdropcutoff, 0};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {1, 1, AlignmentGraph::DummyGraph(), 1, true, true, true, 1, 0, false, .5, 0, 0};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {1, 1, graph, 1, true, true, true, 1, 0, false, .5, 0, 0};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
