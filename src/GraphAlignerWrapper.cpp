...
AlignmentResult AlignOneWay(const AlignmentGraph& graph, const std::string& seq_id, const std::string& sequence, size_t alignmentBandwidth, bool quietMode, GraphAlignerCommon<size_t, int32_t, uint64_t>::AlignerGraphsizedState& reusableState, double preciseClippingIdentityCutoff, int Xdropcutoff, size_t DPRestartStride, int clipAmbiguousEnds)
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {alignmentBandwidth, graph, std::numeric_limits<size_t>::max(), quietMode, preciseClippingIdentityCutoff, Xdropcutoff, 0, clipAmbiguousEnds};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {alignmentBandwidth, graph, maxCellsPerSlice, quietMode, preciseClippingIdentityCutoff, Xdropcutoff, multimapScoreFraction, clipAmbiguousEnds};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {1, AlignmentGraph::DummyGraph(), 1, true, .5, 0, 0, 0};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int32_t, uint64_t>::Params params {1, graph, 1, true, .5, 0, 0, 0};
	GraphAligner<size_t, int32_t, uint64_t> aligner {params};
